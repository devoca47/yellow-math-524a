...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/yellow-math-524a#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/yellow-math-524a
```

A live public deployment of this template is available at [https://yellow-math-524a.templates.workers.dev](https://yellow-math-524a.templates.workers.dev)
